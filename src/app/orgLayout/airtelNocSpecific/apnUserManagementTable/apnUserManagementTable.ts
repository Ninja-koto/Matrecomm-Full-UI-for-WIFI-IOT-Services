...
@Component({
  selector: 'apnUser-Management',
  templateUrl: './apnUserManagementTable.html',
  styleUrls: ['./apnUserManagementTable.scss'],
  providers:	[CollectionTableDataCollectorService],
  encapsulation: ViewEncapsulation.None
})
export class APNUserManagementTable implements OnInit {
