...
@Component({
  selector: 'floor-assignedAssets',
  templateUrl: './floorAssignedAssetsTable.component.html',
  styleUrls: ['./floorAssignedAssetsTable.component.scss'],
  providers:	[CollectionTableDataCollectorService],
  encapsulation: ViewEncapsulation.None
})
export class FloorAssignedAssetsTable implements OnInit {
    ...
    columns= [
     {
        ...
        fn:function(value,object){
          var locStr = ', <b>Building:</b>'+object.Building+'<br><b>City:</b>'+object.City+', <b>Country:</b>'+object.Country;
            locStr = '<b>Floor:</b>'+object.Floor+locStr;
          return locStr;
          }
      },
      {
        ...
        label: 'Asset Details',
        fn:function(value,object){
          var locStr = '<b>Vendor:</b>'+object.vendor+'<br><b>Model:</b>'+object.model;
          return locStr;
        }
      },
      {
      ...
      if(((currTime-this.lastUpdatedTime)/1000)<30)
          ...
          this.tableDataCollectService.project.subscribe(result => {*/
            ...
            if(this.replaceWithNewData==true)
              ...
              {
                if(res.data.length>this.rowsOnEachPage)
                {
                    this.tableData= this.tableData.concat(res.data);
                }
                else
