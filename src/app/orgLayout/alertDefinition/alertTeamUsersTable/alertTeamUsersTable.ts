...
@Component({
  selector: 'alert-TeamUsers',
  templateUrl: './alertTeamUsersTable.html',
  styleUrls: ['./alertTeamUsersTable.scss'],
  providers:	[CollectionTableDataCollectorService],
  encapsulation: ViewEncapsulation.None
})
export class AlertTeamUsersTable implements OnInit {
...
, vcRef: ViewContainerRef) {
  ...
  ngOnInit() {
     this.nsObj = new NameSpaceUtil(this.storage);
      this.namespace = this.nsObj.getNameSpace("AlertMgrUser");
