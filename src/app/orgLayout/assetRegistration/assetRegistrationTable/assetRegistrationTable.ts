...
@Component({
  ...
  templateUrl: './assetRegistrationTable.html',
  styleUrls: ['./assetRegistrationTable.scss'],
  providers:	[CollectionTableDataCollectorService],
  encapsulation: ViewEncapsulation.None
})
export class AssetRegistrationTable implements OnInit {

      tableData :any;
    columns= [
      {
        key: 'profileName',
        label: 'Default Profile Name'
      },
     {
        key: 'description',
        label: 'Description'
      ...
      },
     {
      ...
      {
        key: 'any',
        label: 'Vendor and Model',
        fn:function (value, object) {
          let temp="";
          temp= '<b>Vendor : </b>'+object.vendor+'<br><b>Model : </b>'+object.model;
          return temp;
          }
      },
     {
...
, vcRef: ViewContainerRef) {
  ...
  ngOnInit() {
     this.nsObj = new NameSpaceUtil(this.storage);
      this.namespace = this.nsObj.getNameSpace("AssetRegProfile");
