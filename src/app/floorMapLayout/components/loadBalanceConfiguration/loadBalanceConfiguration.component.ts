...
@Component({
  selector: 'loadBalance-config',
  templateUrl: './loadBalanceConfiguration.component.html',
  styleUrls: ['./loadBalanceConfiguration.component.scss'],
  providers:	[CollectionTableDataCollectorService],
  encapsulation: ViewEncapsulation.None
})
export class LoadBalanceConfigurationTable implements OnInit {
...
, vcRef: ViewContainerRef) {
  ...
  ngOnInit() {
     this.nsObj = new NameSpaceUtil(this.storage);
      this.namespace = this.nsObj.getNameSpace("FloorLoadBalance");
      ...
      paramsForData["dataQuery"]= query;
        ...
        {console.log(this.replaceWithNewData);
