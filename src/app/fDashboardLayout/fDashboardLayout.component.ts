...
@Component({
  selector: 'fDashboardLayout',
  templateUrl:'fDashboardLayout.component.html' ,
  styleUrls:['fDashboardLayout.component.scss'],
  providers:[FDashboardDataService,CollectionTableDataCollectorService]
})
export class FDashboardLayout {
...
interValID:any;
  ...
  private vehicleData:FDashboardDataService,
