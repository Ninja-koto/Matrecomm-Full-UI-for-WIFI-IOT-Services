...
@Component({
  selector: 'switch-authorizationMac',
  templateUrl: './switchAuthorizationMacTable.html',
  styleUrls: ['./switchAuthorizationMacTable.scss'],
  providers:	[CollectionTableDataCollectorService],
  encapsulation: ViewEncapsulation.None
})
export class SwitchAuthorizationMacTable implements OnInit {

      tableData :any;
    columns= [
      {
        key: 'authorizedAssets',
        label: 'Authorized Switches',
        fn:function(value,object){
          ...
          for(let i=0;i<assets.length;i++)
          {
            ...
            locStr = locStr+'<b>AssetName:</b>'+assets[i].switchName+', <b>ID:</b>'+assets[i].macAddress+', <b>SN:</b>'+assets[i].serialNumber;
          }
          return locStr;
          }
      },
...
, vcRef: ViewContainerRef) {
  ...
  ngOnInit() {
     ...
     this.getAllLocations();
      this.namespace = this.nsObj.getNameSpace("AuthorisedSwitchMAC");
