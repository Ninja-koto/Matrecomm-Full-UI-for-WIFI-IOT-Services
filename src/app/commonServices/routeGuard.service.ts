...
@Injectable()
export class OrgRouteGuard implements CanActivate {
    constructor(protected router: Router, private storage:SessionStorageService) {}
     canActivate() {
         ...
         if((String(this.storage.retrieve("productMgrName"))=="null")||
            ...
            {
                if((String(this.storage.retrieve("role"))=="CraftAirOrgMgr")||(String(this.storage.retrieve("role"))=="CraftAirVehicleAdmin"))
                {
