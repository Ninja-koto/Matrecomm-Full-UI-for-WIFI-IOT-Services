...
if(dhcpProfile===undefined)
    this.dhcp=[];
else if(dhcpProfile["pools"]==undefined)
  this.dhcp=[];
else
...
if(radiusProfile===undefined)
    this.radius=[];
else if(radiusProfile["radiusTemplates"]===undefined)
    this.radius=[];
else
...
if(routeProfile===undefined)
  this.route=[];
else if(routeProfile["routes"]===undefined)
  this.route=[];
else
...
this.monitorPktSendFreqVpn=vpnProfile["vpnMonitorPktSendFreq"]
        ...
        {
          let cnt=0
         this.dhcp.forEach(element => {
           element["id"]= new Date().getTime()+cnt++;
         });   
         ...
         this.step2Validition=true;
         cnt=0
         this.portal.forEach(element => {
           element["id"]= new Date().getTime()+cnt++;
         });   
         this.allCaptivePortalProfiles=this.portal;
         console.log("ALL PORTAL");
