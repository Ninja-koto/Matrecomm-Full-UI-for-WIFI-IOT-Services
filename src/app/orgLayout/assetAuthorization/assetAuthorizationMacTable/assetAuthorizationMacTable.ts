...
@Component({
  selector: 'asset-authorizationMac',
  templateUrl: './assetAuthorizationMacTable.html',
  styleUrls: ['./assetAuthorizationMacTable.scss'],
  providers:	[CollectionTableDataCollectorService],
  encapsulation: ViewEncapsulation.None
})
export class AssetAuthorizationMacTable implements OnInit {
...
, vcRef: ViewContainerRef) {
  ...
  ngOnInit() {
     ...
     this.getAllLocations();
      this.namespace = this.nsObj.getNameSpace("AuthorisedAssetMAC");
