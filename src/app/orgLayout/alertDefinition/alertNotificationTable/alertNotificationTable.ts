...
@Component({
  ...
  templateUrl: './alertNotificationTable.html',
  styleUrls: ['./alertNotificationTable.scss'],
  providers:	[CollectionTableDataCollectorService],
  encapsulation: ViewEncapsulation.None
})
export class AlertNotificationTable implements OnInit {
...
getAllTeams(){
      ...
      try{
        ...
        paramsForData1["limit"]=100;
          this.tableDataCollectService.getExtraData(paramsForData1)
            .subscribe(result => {
