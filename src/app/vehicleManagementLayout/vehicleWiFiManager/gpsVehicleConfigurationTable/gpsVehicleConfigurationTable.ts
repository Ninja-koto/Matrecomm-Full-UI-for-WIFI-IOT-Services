...
@Component({
  selector: 'gpsVehicleConfiguration-details',
  templateUrl: './gpsVehicleConfigurationTable.html',
  styleUrls: ['./gpsVehicleConfigurationTable.scss'],
  providers:	[CollectionTableDataCollectorService],
  encapsulation: ViewEncapsulation.None
})
export class GPSVehicleConfigurationComponent implements OnInit {
    tableData :any[];
    columns= [
      {
        "key":"busRouteNumber",
...
, vcRef: ViewContainerRef) {
    ...
    selectedRowData(val:any)
    {
      ...
      this.deleteParamForSelected={"uuid":this.currWizardData.uuid,
                              ...
                              'assignTo':"None",
                              'toSetAssigned':"",
                              'toSetUnAssigned':this.currWizardData.accessPointMac
                            };
    }
  ...
  ngOnInit() {
      ...
      this.namespace = this.nsObj.getNameSpace("GpsBusConfiguration");
