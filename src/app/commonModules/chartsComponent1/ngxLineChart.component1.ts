...
@Component({
  selector: 'app-ngxline-chart1',
  templateUrl: './ngxLineChart.component1.html',
...
export class NgxLineChartComponent1 implements OnInit, OnChanges{
  currentData: any[];
  storedData:any[]=[];
  ...
  @Input() showTimeLineOption:boolean=false;
...
//console.log(filteredData);
    this.currentData= filteredData; //this.storedData;
  ...
  {
    //console.log("In Line Chart filter...");
    this.filterDataForCharts();
  }
  onSelect(event) {
