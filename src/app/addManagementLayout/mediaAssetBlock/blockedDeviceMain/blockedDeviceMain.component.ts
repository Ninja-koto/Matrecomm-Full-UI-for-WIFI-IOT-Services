...
@Component({
  selector: 'blockedDevice-Table',
  templateUrl: './blockedDeviceMain.component.html',
  //styleUrls: ['./mediaStoreTable.component.scss'],
  providers:	[CollectionTableDataCollectorService],
  encapsulation: ViewEncapsulation.None
})
export class blockedDeviceMainTable implements OnInit {
      ...
      },
      {
        ...
        fn: function(value, object) {
          ...
          if(String(value)!="undefined")
            ...
            {
              try{
                movies+=value[i].blockedAssetName+'<br>';
              }catch(e){}
            }
          return movies;
          }
...
, vcRef: ViewContainerRef) {
  ...
  ngOnInit() {
      ...
      this.namespace = this.nsObj.getNameSpace("MediaBlockAsset");
