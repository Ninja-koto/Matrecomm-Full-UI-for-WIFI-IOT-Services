...
@Component({
  selector: 'alert-EscalationProfile',
  templateUrl: './alertEscalationProfileTable.html',
  styleUrls: ['./alertEscalationProfileTable.scss'],
  providers:	[CollectionTableDataCollectorService],
  encapsulation: ViewEncapsulation.None
})
export class AlertEscalationProfileTable implements OnInit {
    ...
    columns= [
     {
      ...
      },
      {
        ...
        fn:function(value,object){
          return '<b>Team Name:</b>'+value.teamName;
          }
      },
      ];
...
, vcRef: ViewContainerRef) {
  ...
  ngOnInit() {
     this.nsObj = new NameSpaceUtil(this.storage);
      this.namespace = this.nsObj.getNameSpace("AlertMgrEscalation");
...
getAllTeams(){
      let ns = this.nsObj.getNameSpace("AlertMgrTeam");
      try{
        var paramsForData1={};
        let query={};
      ...
      {
        console.log("getAllTeams Data load Failed... ");
      }
}
startInterval(){
  var paramsForData={};
