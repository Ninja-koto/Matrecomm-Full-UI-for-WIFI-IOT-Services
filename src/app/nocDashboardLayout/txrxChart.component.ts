...
@Component({
  selector: 'txrx-chart',
  templateUrl: './txrxChart.component.html',
...
export class TXRXChartComponent implements OnInit, OnChanges{
  currentData: any[];
  storedData:any[]=[];
...
config:any={};
  ...
  initiateDataCollection(){
    ...
    console.log(new Date());*/
      ...
      try{
        var paramsForData={}, paramsForData1={};
        paramsForData["namespace"]=this.namespace
        paramsForData["limit"]=-1;
        paramsForData["dataQuery"]= this.pipeLine1;

        paramsForData1["namespace"]= this.namespace;
        paramsForData1["limit"]=-1;
        paramsForData1["dataQuery"]= this.pipeLine2;

          this.viewDataCollectService.getDataOfTwoCalls(paramsForData,paramsForData1)
              .subscribe(result => {
                console.log("DATA");
                console.log(result);
