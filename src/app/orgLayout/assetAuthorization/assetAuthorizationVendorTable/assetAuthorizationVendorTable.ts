...
@Component({
  selector: 'asset-authorizationVendor',
  templateUrl: './assetAuthorizationVendorTable.html',
  styleUrls: ['./assetAuthorizationVendorTable.scss'],
  providers:	[CollectionTableDataCollectorService],
  encapsulation: ViewEncapsulation.None
})
export class AssetAuthorizationVendorTable implements OnInit {
...
, vcRef: ViewContainerRef) {
  ...
  ngOnInit() {
     ...
     this.getAllLocations();
      this.namespace = this.nsObj.getNameSpace("AuthorisedAssetVendor");
