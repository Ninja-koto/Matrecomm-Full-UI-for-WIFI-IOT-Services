...
@Component({
  selector: 'gpsVehicleRouteConfiguration-details',
  templateUrl: './gpsVehicleRouteConfigurationTable.html',
  styleUrls: ['./gpsVehicleRouteConfigurationTable.scss'],
  providers:	[CollectionTableDataCollectorService],
  encapsulation: ViewEncapsulation.None
})
export class GPSVehicleRouteConfigurationComponent implements OnInit {
    tableData :any[];
    columns= [
      {
        "key":"busRouteNumber",
...
, vcRef: ViewContainerRef) {
  ...
  ngOnInit() {
      ...
      this.namespace = this.nsObj.getNameSpace("AdminProfile");
