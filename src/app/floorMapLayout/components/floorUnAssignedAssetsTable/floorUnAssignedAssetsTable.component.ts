...
@Component({
  selector: 'floor-unAssignedAssets',
  templateUrl: './floorUnAssignedAssetsTable.component.html',
  styleUrls: ['./floorUnAssignedAssetsTable.component.scss'],
  providers:	[CollectionTableDataCollectorService],
  encapsulation: ViewEncapsulation.None
})
export class FloorUnAssignedAssetsTable implements OnInit {
...
, vcRef: ViewContainerRef) {
  ...
  ngOnInit() {
     this.nsObj = new NameSpaceUtil(this.storage);
      this.namespace = this.nsObj.getNameSpace("FloorUnAssignedAssets");
