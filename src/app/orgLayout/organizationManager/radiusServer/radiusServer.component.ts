...
@Component({
  ...
  templateUrl: './radiusServer.component.html',
  styleUrls: ['./radiusServer.component.scss'],
  providers:	[CollectionTableDataCollectorService],
  encapsulation: ViewEncapsulation.None
})
export class RadiusServerComponent implements OnInit {
    tableData :any;
    columns= [
      {
        "key":"radiusType",
        "label":"Radius Server Type"
      }
      ];
...
, vcRef: ViewContainerRef) {
  ...
  ngOnInit() {
     this.nsObj = new NameSpaceUtil(this.storage);
      this.namespace = this.nsObj.getNameSpace("RadiusServer");
