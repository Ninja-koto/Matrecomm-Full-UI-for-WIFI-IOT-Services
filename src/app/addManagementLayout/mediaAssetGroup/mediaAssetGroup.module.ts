...
import { routing }       from './mediaAssetGroup.routing';
...
import {ProfileMediaAddWizardComponent} from "../mediaAssetGroup/add-wizard/mediaAssetGroup-wizard.component"
...
@NgModule({
  ...
  bootstrap: [ MediaAssetGroup ]
})
export class MediaAssetGroupModule { }
