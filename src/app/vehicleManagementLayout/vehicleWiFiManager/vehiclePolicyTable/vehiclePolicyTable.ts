...
@Component({
  selector: 'vehiclePolicy-details',
  templateUrl: './vehiclePolicyTable.html',
  styleUrls: ['./vehiclePolicyTable.scss'],
  providers:	[CollectionTableDataCollectorService],
  encapsulation: ViewEncapsulation.None
})
export class VehiclePolicyComponent implements OnInit {
    tableData :any[];
    columns= [
      {
        "key":"policyName",
...
, vcRef: ViewContainerRef) {
  ...
  ngOnInit() {
      ...
      this.namespace = this.nsObj.getNameSpace("BusPolicy");
