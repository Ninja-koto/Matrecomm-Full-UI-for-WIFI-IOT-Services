...
@Component({
  selector: 'mediaStore-add-wizard',
  templateUrl: './mediaStore-wizard.component.html',
  //styleUrls: ['./mediaStore-wizard.component.css'],
  providers:[RPCService]
})

export class MediaStoreAddWizardComponent implements OnInit {
