...
@Component({
  ...
  templateUrl: './assetConfigurationTable.html',
  styleUrls: ['./assetConfigurationTable.scss'],
  providers:	[CollectionTableDataCollectorService],
  encapsulation: ViewEncapsulation.None
})
export class AssetConfigurationTable implements OnInit {
...
, vcRef: ViewContainerRef) {
  ...
  ngOnInit() {
     ...
     this.getAllRegProfiles();
      this.namespace = this.nsObj.getNameSpace("AssetCfgTemplate");
