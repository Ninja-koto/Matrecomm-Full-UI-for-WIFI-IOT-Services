...
@Component({
  selector: 'UserManagement-Table',
  templateUrl: './userManagementTable.component.html',
...
export class UserManagementTable implements OnInit {
    ...
    columns= [
      {
        key: 'firstName',
        label: 'User and Room No.',
        fn:function(value,object){
          let ret="";
          ret = "<b>FirstName :</b> "+ object["firstName"]+",<br><b>Room Number :</b> "+ object["roomNumber"];
          return ret;//new Date(value).toLocaleDateString()+", "+new Date(value).toLocaleTimeString();
        }
      },
      {
        key:'checkInTime',
        ...
        fn:function(value,object){
          let ret="";
          ret = "<b>Check-In :</b> "+ object["checkInTime"]+",<br><b>Check-Out :</b> "+ object["checkOutTime"];
          return ret;//new Date(value).toLocaleDateString()+", "+new Date(value).toLocaleTimeString();
        }
      },
      {
...
, vcRef: ViewContainerRef) {
  ...
  ngOnInit() {
      ...
      this.namespace = this.nsObj.getNameSpace("HotelUserManagement");
