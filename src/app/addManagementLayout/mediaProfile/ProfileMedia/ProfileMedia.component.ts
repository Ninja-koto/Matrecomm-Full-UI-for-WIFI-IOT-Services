        ...
        fn: function(value, object) {
          ...
          {let cnt=0;
            for(let i=0; i < value.length; i++)
            {
              ...
              try{
                movies+=value[i].selectedMovieName+'<br>';
              }catch(e){}
              cnt++;
            }
          }
        ...
        fn: function(value, object) {
          ...
          {let cnt=0;
            for(let i=0; i < value.length; i++)
            {
              ...
              try{
                songs+=value[i].selectedSongName+'<br>';
              }catch(e){}
              cnt++;
            }
            }
...
, vcRef: ViewContainerRef) {
  ...
  ngOnInit() {
      ...
      this.namespace = this.nsObj.getNameSpace("MediaProfiles");
      this.getAllSongs();
      this.getAllSerials();
      this.getAllMovies();
...
getAllSongs(){
  let ns = this.nsObj.getNameSpace("MediaStore");
  try{
    var paramsForData1={};
    let query={"selectedMediaGenre" : "Songs"};
    let projectQuery={};
  /*  projectQuery["filename"]=1;
    ...
    paramsForData1["limit"]=100;
      this.tableDataCollectService.getPostData(paramsForData1)
        .subscribe(result => {
              console.log("All Media songs Files : ");
              this.allSongsFiles=result.data;
              console.log(this.allSongsFiles);
      });
  }
  catch(e)
  {
    console.log("get Media songs  Data load Failed... ");
  }
}
...
getAllMovies(){
  ...
  try{
    var paramsForData1={};
    let query={"selectedMediaGenre" : "Movies"};
    let projectQuery={};
  /*  projectQuery["filename"]=1;
    projectQuery["length"]=1;
    projectQuery["uploadDate"]=1;*/
    ...
    paramsForData1["limit"]=100;
      this.tableDataCollectService.getPostData(paramsForData1)
        .subscribe(result => {
              console.log("All Media Movies Files : ");
              this.allMovieFiles=result.data;
              console.log(this.allMovieFiles);
      });
  }
  catch(e)
  {
    console.log("get Media Movies  Data load Failed... ");
  }
}
...
getAllSerials(){
  ...
  try{
    var paramsForData1={};
    let query={"selectedMediaGenre" : "Serials"};
    let projectQuery={};
  /*  projectQuery["filename"]=1;
    projectQuery["length"]=1;
    projectQuery["uploadDate"]=1;*/
    ...
    paramsForData1["limit"]=100;
      this.tableDataCollectService.getPostData(paramsForData1)
        .subscribe(result => {
              console.log("All Media Serials Files : ");
              this.allSerialFiles=result.data;
              console.log(this.allSerialFiles);
      });
  }
  catch(e)
  {
    console.log("get Media Serials  Data load Failed... ");
  }
}
