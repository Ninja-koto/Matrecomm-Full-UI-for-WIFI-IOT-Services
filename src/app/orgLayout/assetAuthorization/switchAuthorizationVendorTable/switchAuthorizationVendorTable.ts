...
@Component({
  selector: 'switch-authorizationVendor',
  templateUrl: './switchAuthorizationVendorTable.html',
  styleUrls: ['./switchAuthorizationVendorTable.scss'],
  providers:	[CollectionTableDataCollectorService],
  encapsulation: ViewEncapsulation.None
})
export class SwitchAuthorizationVendorTable implements OnInit {
      ...
      },
     {
        ...
        fn:function(value,object){
          ...
          for(let i=0;i<assets.length;i++)
          {
            if(i>itCount) break;
            if(i>0) locStr = locStr+",<br>";
            locStr = locStr+'<b>Vendor:</b>'+assets[i].vendor+', <b>Model:</b>'+assets[i].model+', <b>FirmWare:</b>'+assets[i].firmware;
          }
          return locStr;
          }
      }
...
, vcRef: ViewContainerRef) {
  ...
  ngOnInit() {
     ...
     this.getAllLocations();
      this.namespace = this.nsObj.getNameSpace("AuthorisedSwitchVendor");
