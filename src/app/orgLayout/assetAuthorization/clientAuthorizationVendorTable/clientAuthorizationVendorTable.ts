...
@Component({
  selector: 'client-authorizationVendor',
  templateUrl: './clientAuthorizationVendorTable.html',
  styleUrls: ['./clientAuthorizationVendorTable.scss'],
  providers:	[CollectionTableDataCollectorService],
  encapsulation: ViewEncapsulation.None
})
export class ClientAuthorizationVendorTable implements OnInit {
...
, vcRef: ViewContainerRef) {
  ...
  ngOnInit() {
     ...
     this.getAllLocations();
      this.namespace = this.nsObj.getNameSpace("AuthorisedClientVendor");
