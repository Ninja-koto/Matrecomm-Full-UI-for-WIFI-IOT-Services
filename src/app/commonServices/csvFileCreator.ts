...
export class CsvConfigConsts {
	...
	public static DEFAULT_TITLE = 'Report';
...
export class CsvCreator {
	...
	private csv = "";
    private exHeader:any;

	constructor(DataJSON: any, filename:string, private title:string) {
	...
	getHeaders(): void {
		if(this._options.showLabels) {
			...
			for (var index in this.data[0]) {
				row += this.exHeader[index] + this._options.fieldSeparator;
			}
