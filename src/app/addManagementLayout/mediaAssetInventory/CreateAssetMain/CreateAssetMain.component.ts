...
@Component({
  selector: 'CreateAssetMedia-Table',
  templateUrl: './CreateAssetMain.component.html',
  //styleUrls: ['./mediaStoreTable.component.scss'],
  providers:	[CollectionTableDataCollectorService],
  encapsulation: ViewEncapsulation.None
})
export class CreateAssetMediaTable implements OnInit {
...
, vcRef: ViewContainerRef) {
  ...
  ngOnInit() {
      ...
      this.namespace = this.nsObj.getNameSpace("MediaAsset");
...
getAllMediaFiles(){
  let ns = this.nsObj.getNameSpace("uploads.files");
  try{
    var paramsForData1={};
    let query={};
    let projectQuery={};
