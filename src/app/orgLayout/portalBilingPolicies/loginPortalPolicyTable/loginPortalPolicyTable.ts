...
@Component({
  selector: 'login-PortalPolicy',
  templateUrl: './loginPortalPolicyTable.html',
  styleUrls: ['./loginPortalPolicyTable.scss'],
  providers:	[CollectionTableDataCollectorService],
  encapsulation: ViewEncapsulation.None
})
export class LoginPortalPolicyTable implements OnInit {

      tableData :any;
    columns= [
     {
        key: 'portalName',
        label: 'Login Portal Name'
      },
      {
       key: 'landingURL',
        label: 'Landing Url'
...
, vcRef: ViewContainerRef) {
  ...
  ngOnInit() {
     this.nsObj = new NameSpaceUtil(this.storage);
      this.namespace = this.nsObj.getNameSpace("CcpLoginDetails");
