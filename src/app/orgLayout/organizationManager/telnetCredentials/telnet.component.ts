...
@Component({
  selector: 'telnet-details',
  templateUrl: './telnet.component.html',
  styleUrls: ['./telnet.component.scss'],
  providers:	[CollectionTableDataCollectorService],
  encapsulation: ViewEncapsulation.None
})
export class TelnetComponent implements OnInit {
    tableData :any;
    columns= [
      {
        "key":"username",
...
, vcRef: ViewContainerRef) {
  ...
  ngOnInit() {
     this.nsObj = new NameSpaceUtil(this.storage);
      this.namespace = this.nsObj.getNameSpace("CraftAirOrgTELNET");
