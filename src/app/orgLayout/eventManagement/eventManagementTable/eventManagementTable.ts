...
@Component({
  ...
  templateUrl: './eventManagementTable.html',
  styleUrls: ['./eventManagementTable.scss'],
  providers:	[CollectionTableDataCollectorService],
  encapsulation: ViewEncapsulation.None
})
export class EventManagementTable implements OnInit {
...
, vcRef: ViewContainerRef) {
  ...
  ngOnInit() {
     this.nsObj = new NameSpaceUtil(this.storage);
      this.namespace = this.nsObj.getNameSpace("EventManagement");
